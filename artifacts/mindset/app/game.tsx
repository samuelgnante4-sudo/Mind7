...
import { CATEGORY_COLORS, CATEGORY_LABELS, LEVELS, MemoryLevel, PatternLevel, QuizLevel, ReflectionLevel, SequenceLevel } from "@/data/levels";
      ...
      >
        <Animated.View style={[styles.content, { opacity: fadeAnim }]}>
          ...
          <View style={styles.titleBlock}>
            <Text style={[styles.levelNum, { color: colors.mutedForeground }]}>Niveau {level.id}</Text>
          ...
          {!completed ? (
            ...
            <View style={styles.completedBlock}>
              <View style={[styles.completedIcon, { backgroundColor: catColor + "20", borderColor: catColor + "44" }]}>
                <Ionicons name="checkmark" size={36} color={catColor} />
              </View>
              <Text style={[styles.completedTitle, { color: colors.foreground }]}>Niveau terminé !</Text>
              <Text style={[styles.completedSub, { color: colors.mutedForeground }]}>+100 points</Text>
              ...
              {nextLevel ? (
                ...
                <Text style={[styles.completedSub, { color: colors.mutedForeground }]}>Tu as terminé tous les niveaux !</Text>
              )}
...
const styles = StyleSheet.create({
  ...
  lvlBadge: { width: 36, height: 36, borderRadius: 10, borderWidth: 1, alignItems: "center", justifyContent: "center" },
  ...
  content: { gap: 28 },
  titleBlock: { gap: 4 },
  levelNum: { fontSize: 11, fontFamily: "Inter_500Medium", letterSpacing: 2, textTransform: "uppercase" },
  levelTitle: { fontSize: 26, fontFamily: "Inter_700Bold", lineHeight: 34 },
  completedBlock: { alignItems: "center", gap: 16, paddingTop: 20 },
  completedIcon: { width: 80, height: 80, borderRadius: 40, borderWidth: 2, alignItems: "center", justifyContent: "center" },
