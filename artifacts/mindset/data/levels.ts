...
export interface ReflectionLevel extends BaseLevel {
  ...
  scenario: string;
  options: string[];
  optionScores: number[]; // one per option, -3 (cold/psychopathic) to +3 (altruistic/empathetic)
  insight: string;
  psychology: {
    concept: string;
    explanation: string;
...
export const LEVELS: Level[] = [
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "Peter Singer (1972). Notre cerveau accorde une valeur morale radicalement différente à une menace visible et immédiate vs une menace abstraite et lointaine. L'enfant devant toi crée une réponse émotionnelle immédiate. L'enfant à 5000 km reste statistique.",
      known: "célèbre",
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "Judith Jarvis Thomson (1971). Ce dilemme montre que le droit à la vie ne donne pas automatiquement le droit d'utiliser le corps d'autrui. La plupart des gens qui se débranchent ne se sentent pas meurtriers. Et pourtant.",
      known: "célèbre",
  ...
  },
  {
    ...
    optionScores: [2, -1.5, 1],
    insight: "Lawrence Kohlberg a utilisé ce dilemme pour mesurer le développement moral. Il n'existe pas de 'bonne' réponse — seulement différents niveaux de raisonnement moral.",
    psychology: {
      concept: "Stades du Développement Moral de Kohlberg",
      explanation: "Lawrence Kohlberg (1958). Stade 1 (enfant) : ne pas voler pour éviter la punition. Stade 3 : ne pas voler pour ne pas décevoir. Stade 5 : voler car la vie prime la propriété. La plupart des adultes raisonnent au stade 3 ou 4.",
      known: "célèbre",
  ...
  // ── CHAPITRE 2 : Corps & Esprit ───────────────────────────────────────────
  {
    ...
    psychology: {
      ...
      explanation: "Robert Nozick (1974). Cet argument prouve que les humains ne veulent pas seulement du bonheur subjectif — ils veulent que ce bonheur soit réel. Ceux qui refusent la machine accordent de la valeur à l'authenticité, au lien véritable, à l'action dans le monde.",
      known: "célèbre",
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "Plutarque (Ier siècle). En psychologie, ce paradoxe éclaire la question du moi : qu'est-ce qui définit l'identité quand la matière change ? John Locke répondait : la mémoire. Derek Parfit : l'identité est une illusion narrative.",
      known: "célèbre",
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "Judith Jarvis Thomson (1985). Ce cas montre les limites du pur raisonnement utilitariste. Le philosophe Bernard Williams appelle ça 'l'intégrité morale' : certains actes nous définissent comme personnes, indépendamment des conséquences.",
      known: "méconnu",
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "Paul Ricoeur (1985) + expériences sur la mémoire reconstituée. Elizabeth Loftus a prouvé que nos souvenirs sont déjà falsifiés — ils changent chaque fois qu'on les rappelle. Ce qu'on croit être 'notre vrai souvenir' est déjà une reconstruction.",
      known: "méconnu",
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "René Descartes (1641), repris par Hilary Putnam (1981). Tout ce que tu 'vis' est déjà une simulation : ton cerveau reçoit des signaux électriques et construit une réalité. Il n'a pas d'accès direct au monde.",
      known: "célèbre",
  ...
  // ── CHAPITRE 3 : La Société ───────────────────────────────────────────────
  {
    ...
    psychology: {
      ...
      explanation: "Stanley Milgram (1961). La conclusion : la majorité obéit à une autorité perçue comme légitime, même contre ses valeurs. Les nazis ordinaires n'étaient pas des monstres. C'est bien plus effrayant.",
      known: "célèbre",
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "John Darley & Bibb Latané (1968), après l'affaire Kitty Genovese. La diffusion de responsabilité : chacun suppose que quelqu'un d'autre va agir. Solution connue : regarder une personne spécifique dans les yeux et lui dire 'Vous, aidez-moi.'",
      known: "célèbre",
  ...
  },
  {
    ...
    optionScores: [-1, 1, 1.5],
    insight: "Peu importe ce que tu choisis, tu vivras avec la tension entre deux valeurs : la loyauté et la justice. Il n'y a pas d'issue propre.",
    psychology: {
      concept: "Dissonance Cognitive",
      explanation: "Leon Festinger (1957). Quand deux valeurs que tu tiens entrent en conflit, ton cerveau ressent une douleur réelle — mesurable par IRM. Pour la réduire, tu rationaliseras ton choix après coup.",
      known: "célèbre",
  ...
  },
  {
    ...
    category: "psychologie",
    title: "Le prisonnier",
    scenario: "Tu es arrêté avec un complice. Si tu témoignes contre lui, tu sors libre et il prend 10 ans. Si vous vous taisez tous les deux, vous prenez 2 ans chacun. Que fais-tu ?",
    ...
    psychology: {
      ...
      explanation: "Merrill Flood & Melvin Dresher (1950). Ce dilemme explique pourquoi les nations s'arment, pourquoi les entreprises se font concurrence au détriment de toutes, et pourquoi la coopération est si difficile à maintenir.",
      known: "célèbre",
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "Emmanuel Kant (1785) vs John Stuart Mill (1863). La plupart des humains sont naturellement conséquentialistes dans la vie quotidienne et déontologistes en principe.",
      known: "célèbre",
  ...
  // ── CHAPITRE 4 : La Morale ────────────────────────────────────────────────
  {
    ...
    psychology: {
      ...
      explanation: "Paul Slovic (1967). Le cerveau ne traite pas les statistiques comme des personnes réelles. L'évolution t'a programmé pour protéger tes liens directs — pas pour optimiser les résultats globaux.",
      known: "célèbre",
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "Concept de 'mains sales' (Bernard Williams, 1973). Psychologiquement, l'argent 'contaminé' active un sentiment de souillure que la raison ne peut pas effacer.",
      known: "méconnu",
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "Tania Singer & Ernst Fehr (2006). L'IRM montre que punir quelqu'un qui a triché active le striatum ventral — le même circuit que recevoir de l'argent ou manger du chocolat. La vengeance procure un plaisir neurologique réel.",
      known: "méconnu",
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "Yaacov Trope & Nira Liberman (2010). Plus une personne est éloignée, moins notre cerveau lui accorde de poids moral. Ce n'est pas de la méchanceté — c'est l'architecture de notre empathie.",
      known: "célèbre",
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "Abraham Maslow (1943) + Lawrence Kohlberg. Notre système moral a des priorités. La survie prime la propriété — biologiquement et instinctivement.",
      known: "célèbre",
  ...
  // ── CHAPITRE 5 : L'Identité ───────────────────────────────────────────────
  {
    ...
    psychology: {
      ...
      explanation: "Erving Goffman (1959). Nous jouons en permanence un 'rôle social'. Les études montrent que nos pensées privées sont bien plus critiques, sexuelles, agressives et égoïstes que nos comportements — et c'est normal.",
      known: "méconnu",
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "Derek Parfit (1984). Parfit argumente que notre identité est fondée sur la continuité des souvenirs et de la psychologie — pas sur un 'soi' permanent.",
      known: "méconnu",
  ...
  },
  {
    ...
    scenario: "On te propose : pendant 1 an, tout ce que tu fais est invisible aux autres — personne ne peut te juger ou te voir. Comment vis-tu cette année ?",
    ...
    psychology: {
      ...
      explanation: "Platon, La République (380 av. J.-C.). Les études montrent que la présence d'un observateur — même fictif, même un simple dessin d'yeux — augmente les comportements prosociaux de 30 à 50%.",
      known: "célèbre",
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "Harry Triandis (1995). Les cultures collectivistes voient l'obligation familiale comme une valeur positive. Les cultures individualistes valorisent l'autonomie personnelle. Ni l'une ni l'autre n'est 'meilleure'.",
      known: "méconnu",
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "Christopher Long & James Averill (2003). La solitude non choisie est toxique. La solitude choisie est régénératrice. Blaise Pascal : 'Tout le malheur des hommes vient de ne savoir pas demeurer en repos dans une chambre.'",
      known: "méconnu",
  ...
  // ── CHAPITRE 6 : L'Univers ────────────────────────────────────────────────
  {
    ...
    scenario: "Une catastrophe va détruire la Terre dans 1 heure. Tu peux embarquer dans une navette et sauver soit ta famille (5 personnes), soit une sélection de 100 inconnus représentant la diversité de l'humanité.",
    ...
    psychology: {
      ...
      explanation: "Bernard Williams (1976) critique l'utilitarisme sur ce point précis : une théorie morale qui te demande de sacrifier ta famille pour l'humanité est une théorie qui 'a un projet de trop'.",
      known: "méconnu",
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "Benjamin Libet (1983). L'électroencéphalogramme détecte le 'potentiel de préparation' jusqu'à 550ms avant que le sujet soit conscient de décider. Sam Harris argumente que le libre arbitre est une illusion totale. Daniel Dennett répond que le libre arbitre compatible avec le déterminisme est réel.",
      known: "célèbre",
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "Jeff Greenberg, Sheldon Solomon & Tom Pyszczynski (1986). Quand on rappelle à des gens leur propre mort, ils deviennent plus conservateurs, plus nationalistes et plus défensifs de leurs croyances.",
      known: "méconnu",
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "Bernard Williams (1973). L'immortalité viderait de sens les projets humains. Sans limite de temps, sans risque, sans mort, les désirs perdraient leur urgence.",
      known: "méconnu",
  ...
  },
  {
    ...
    psychology: {
      ...
      explanation: "Daniel Kahneman (2011). Notre 'moi mémoriel' juge notre vie différemment du 'moi expérienciel'. Les études sur les regrets en fin de vie montrent que les gens regrettent moins ce qu'ils ont fait que ce qu'ils n'ont pas osé faire.",
      known: "méconnu",
